...
ids = [
    ("rect2x2_reference", "2mx2m reference"),
    (
        "rect2x2_freeze_BN_0_1_TN_0_batch_size_600_src_pos_3ppw_target_2D",
        "2mx2m target (60% samples)",
    ),
]

sim_tag = "Lshape_2_5x2_5_transfer"
ids = [
    ("Lshape2_5x2_5_reference", "L-shape 2.5mx2.5m reference"),
    (
        "Lshape2_5x2_5_srcpos_5ppw_freeze_BN_0_1_TN_0_batch_size_600_target_2D",
        "L-shape 2.5mx2.5m target",
    ),
    (
        "Lshape2_5x2_5_freeze_BN_0_1_TN_0_batch_size_600_src_pos_3ppw_target_2D",
        "L-shape 2.5mx2.5m target (60% samples)",
    ),
]

sim_tag = "rect3x3_furn_transfer"
ids = [
    ("rect_furn_3x3_BS_600_reference", "3mx3m 'furnished' reference (TN BS 600)"),
    (
        "rect3x3_furn_freeze_BN_0_1_TN_0_batch_size_600_target_2D",
        "3mx3m 'furnished' target",
    ),
    (
        "rect3x3_furn_freeze_BN_0_1_TN_0_batch_size_600_src_pos_3ppw_target_2D",
        "3mx3m 'furnished' target (60% samples)",
    ),
]

#### SENSIBILITY ANALYSIS ####
ids = [
    ("1_baseline_tanh_mlp", "tanh MLP"),
...
ids = [
    ("1_baseline_tanh_mod_mlp_nofeat", "tanh Mod-MLP"),
...
ids = [
    ("4_baseline_batchsize_16_100", "BS 16/100"),
...
ids = [
    ("6_baseline_bn2_tn2", "BN=2PPW TN=2PPW"),
...
ids = [
    ("6_baseline_bn2_tn6", "dx_src=5 dx=6PPW, dt=6PPW"),
...
ids = [
    ("7_dxu2_dx6_dt2_srcdx2", "FNN reference"),
