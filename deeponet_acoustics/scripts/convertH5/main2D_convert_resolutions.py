...
filepath_in = (
    "/work3/nibor/1TB/deeponet/input_1D_2D/rect2x2_freq_indep_ppw265_train_orig.h5"
)
...
time_steps_train = convertH5.prunePPW2DH5(
    filepath_in,
    filepath_out,
    uprune_factor=uprune_factor,
    p_ppw=p_ppw,
    t_ppw=t_ppw,
    src_density_fact=src_density_fact,
    dtype=np.float16,
)
...
time_steps_val = convertH5.prunePPW2DH5(
    filepath_in,
    filepath_out,
    uprune_factor=uprune_factor,
    p_ppw=p_ppw,
