...
rsync -a --delete --ignore-existing /work3/nibor/1TB/input3D/cube6x6x6_1000hz_p6_5ppw_srcs393_train /localssd0/nibor/ || { echo 'copying training data failed' ; exit 1; }
