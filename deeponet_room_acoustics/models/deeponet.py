...
from deeponet_room_acoustics.models.datastructures import NetworkArchitectureType, TrainingSettings, TransferLearning
from deeponet_room_acoustics.utils.timings import TimingsWriter
from deeponet_room_acoustics.utils.utils import expandCnnData
from deeponet_room_acoustics.models.networks_flax import flattened_traversal, freezeLayersToKeys, freezeCnnLayersToKeys
from deeponet_room_acoustics.models import loss_functions
...
class DeepONet:    
    ...
    def trainFromDataset1D2D(self, dataset, dataset_val, nIter, save_every=100, do_timings=False):
