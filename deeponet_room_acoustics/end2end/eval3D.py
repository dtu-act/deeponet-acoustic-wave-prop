...
from deeponet_room_acoustics.models.datastructures import EvaluationSettings, NetworkArchitectureType, TransferLearning
from deeponet_room_acoustics.datahandlers.datagenerators import DataH5Compact, DataSourceOnly, DatasetStreamer, getNumberOfSources
...
# settings_path = "json_setups/threeD/cube6x6x6.json"
# settings_eval_path = "json_setups/threeD/cube_6ppw_resnet"

# settings_path = "json_setups/threeD/cube.json"
# settings_eval_path = "json_setups/threeD/cube_eval.json"

# settings_path = "json_setups/threeD/settings.json"
# settings_eval_path = "json_setups/threeD/cube_eval.json"

# settings_path = "json_setups/threeD/cube6x6x6.json"
# settings_eval_path = "json_setups/threeD/cube6x6x6_6srcpos_eval.json"

# evaluate(settings_path, settings_eval_path)

def evaluate(settings_dict: dict[str, Any], settings_eval_dict: dict[str, Any], prune_spatial = 1):
